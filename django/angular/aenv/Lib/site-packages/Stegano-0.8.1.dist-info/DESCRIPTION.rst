...
`St̩gan̫ <https://github.com/cedricbonhomme/Stegano>`_, a pure Python
Steganography module.

Steganography is the art and science of writing hidden messages in such a way
that no one, apart from the sender and intended recipient, suspects the
existence of the message, a form of security through obscurity. Consequently,
functions provided by St̩gan̫ only hide messages, without encryption.
...
You will be able to use St̩gan̫ in your Python programs or as a command line
tool.
...
Use St̩gan̫ as a library in your Python program
'''''''''''''''''''''''''''''''''''''''''''''''

If you want to use St̩gan̫ in your Python program you just have to import the
...
* improvements of the command line of St̩gan̫. The use of St̩gan̫ through the
  command line has slightly changed ('hide' and 'reveal' are now sub-parameters
  of the command line). No changes if you use St̩gan̫ as a module in your
...
* you can now use St̩gan̫ as a library in your Python program;
  (python setup.py install) or as a 'program' thanks to the scripts provided
  in the bin directory;
* new documentation (reStructuredText) comes with St̩gan̫.
